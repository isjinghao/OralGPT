...
def _judge_record(
    ...
    with semaphore:
        ...
        rubric_max_tokens = int(os.environ.get("STEP4_TREATMENT_JUDGE_MAX_TOKENS", "8192"))
        return (
            judge_rubric(llm, record, rubric_by_task[record["task_id"]], max_tokens=rubric_max_tokens),
            judge_evidence(llm, record, max_tokens=rubric_max_tokens),
        )

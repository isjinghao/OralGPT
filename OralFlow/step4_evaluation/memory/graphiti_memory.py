...
class GraphitiMemory(MemoryMethod):
    ...
    def setup(self, workdir, namespace: str = "") -> None:
        ...
        llm_config = LLMConfig(
            api_key=os.environ.get("GRAPHITI_OPENAI_API_KEY") or memo_api_key(),
            base_url=os.environ.get("GRAPHITI_OPENAI_BASE_URL") or os.environ.get("MEMO_OPENAI_BASE_URL", "https://api.openai.com/v1"),
            model=os.environ.get("GRAPHITI_OPENAI_MODEL") or os.environ.get("MEMO_OPENAI_MODEL", "gpt-4o-mini"),
            temperature=0,
        )
    ...
    def update(self, llm, cache_key: str) -> None:
        ...
        self._async_loop.run(self._graphiti.add_episode(
                ...
                source_description="OralFlow released clinical stage",

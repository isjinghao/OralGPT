...
def main():
    ...
    parser.add_argument('--json_path', type=str,
                        default="/hpc2hdd/home/yfan546/workplace/mllm_playground/mllm_2/r1/source_data/3_706/Multimodal_data_DENTEX_CHALLENGE_2023.json",
                        help='JSON file path')
    parser.add_argument('--proposals_path', type=str,
                        default="/hpc2hdd/home/yfan546/workplace/mllm_playground/mllm_2/r1/source_data/3_706/proposals_data3.json",
                        help='Proposals JSON file path')
    parser.add_argument('--data_path', type=str,
                        default="/hpc2hdd/home/yfan546/workplace/mllm_playground/mllm_2/r1/source_data/3_706/",
                        help='Data root directory path')
    parser.add_argument('--output_path', type=str,
                        default='/hpc2hdd/home/yfan546/workplace/mllm_playground/mllm_2/r1/mmoral_reasoning_data/multi_round_output_data3',
    ...
    parser.add_argument('--shard_id', type=int, default=1, help='Shard ID for parallel processing')
    parser.add_argument('--num_shards', type=int, default=2, help='Total number of shards for automatic splitting')

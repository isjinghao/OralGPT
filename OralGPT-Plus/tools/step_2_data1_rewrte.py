...
def parse_args():
    ...
    parser.add_argument(
        "--input-path",
        type=str,
        default="/hpc2hdd/home/yfan546/workplace/mllm_playground/mllm_2/r1/mmoral_reasoning_data/multi_round_output_data1/multi_round_data1.json",
        help="Input JSON file path"
    )
    parser.add_argument(
        "--output-path",
        type=str,
        default="/hpc2hdd/home/yfan546/workplace/mllm_playground/mllm_2/r1/mmoral_reasoning_data/multi_round_output_data1/multi_round_data1_step_2.json",
        help="Output JSON file path"
    )
    parser.add_argument(
        "--checkpoint-path",
        type=str,
        default="/hpc2hdd/home/yfan546/workplace/mllm_playground/mllm_2/r1/mmoral_reasoning_data/multi_round_output_data1/checkpoint.json",
...
def make_assistant_turn_messages(assistant_content: str,
    ...
    """
    # data1: no preset disease definitions or matching; rewrite based only on
    # existing content plus optional gpt-4-analysis.
    sys_text = (
        ...
        "3) If multiple regions/teeth in THIS round share similar findings, MERGE them into ONE sentence listing the regions/teeth.\n"
        "4) Do NOT fabricate bbox, coordinates, teeth IDs, or tools. Do NOT add or remove tags.\n"
        "5) If `gpt_4_analysis` is provided (non-empty), you MUST weave its salient insights into the rewritten `<think>` "
    ...
    usr_payload = {
        ...
        # data1 provides no disease definitions
        "scoped_disease_definitions": {},
...
def rewrite_assistant_message_content(content: str, gpt4_analysis: Optional[str], args) -> str:
    ...
    # data1: no disease term matching, empty context
    disease_ctx = {}
